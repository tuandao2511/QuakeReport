...
public final class QueryUtils {
    ...
    public static List<Earthquake> FetchEarthquakeData(String requestUrl) {
        ...
        List<Earthquake> earthquakes = extractEarthquakes(jsonReponse);
    ...
    public static List<Earthquake> extractEarthquakes(String jsonResponse) {
        ...
        try {
           ...
           for(int i=0; i<jsonArray.length(); i++) {
               JSONObject jsonObjectFeatures = jsonArray.getJSONObject(i);
               JSONObject jsonObject = jsonObjectFeatures.getJSONObject("properties");

               double magnitude = jsonObject.getDouble("mag");
               String place = jsonObject.getString("place");
               long date = jsonObject.getLong("time");
